...
const pngPath = path.join(outputDir, 'preview2.png');
const gifPath = path.join(outputDir, 'preview-smooth2.gif');
...
const bottomFrames = Math.round(
    bottomPause / frameDelay,
);
