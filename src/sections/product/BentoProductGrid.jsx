    ...
    <section className="p-8 md:p-16 md:max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        >
          <div className="h-full flex flex-col justify-between">
            ...
            <div className="aspect-video bg-primary-white/10  rounded-xl mt-4 flex items-center justify-center">
              <span className="text-6xl font-black text-primary-white/30 dark:text-primary-black/30 select-none">
                P
              </span>
            </div>
          </div>
        ...
        >
          ...
          <h4 className="font-bold text-sm text-primary-black dark:text-primary-white">
            Icon Pack
          </h4>
        ...
        >
          <h4 className="font-bold text-sm text-primary-black dark:text-primary-white mb-2">
            Templates
          </h4>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-primary-black dark:bg-primary-orange rounded-xl flex items-center justify-center shrink-0">
              <span className="text-2xl font-black text-primary-white dark:text-primary-black select-none">
                B
              </span>
            </div>
            <div>
