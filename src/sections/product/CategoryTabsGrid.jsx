...
export default function CategoryTabsGrid() {
  ...
  return (
    <section className="p-8 md:p-16 md:max-w-7xl mx-auto">
      <div className="mb-8">
        <h3 className="text-xs uppercase tracking-[0.2em] text-primary-black/50 dark:text-primary-white/50 mb-2">Category Tabs + Grid</h3>
        <p className="text-sm text-primary-black/60 dark:text-primary-white/60">Example: Multi-category store — tabbed navigation with filtered grid.</p>
      </div>
        ...
        {categories[activeTab].map((item, idx) => (
          ...
          >
            <div className="aspect-square bg-primary-black/5 dark:bg-primary-white/5 rounded-xl mb-4 flex items-center justify-center">
              <span className="text-5xl font-black text-primary-black/10 dark:text-primary-white/10 select-none">{item.name[0]}</span>
            </div>
