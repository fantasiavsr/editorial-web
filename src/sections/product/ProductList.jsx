...
export default function ProductList() {
  const products = [
    { name: "Wireless Headphones", type: "Electronics", price: "$349", available: 24 },
    { name: "Leather Backpack", type: "Accessories", price: "$129", available: 0 },
  ...
  return (
    <section className="p-8 md:p-16 md:max-w-7xl mx-auto">
      <div className="mb-8">
        <h3 className="text-xs uppercase tracking-[0.2em] text-primary-black/50 dark:text-primary-white/50 mb-2">Product List</h3>
        <p className="text-sm text-primary-black/60 dark:text-primary-white/60">Example: Inventory view — full-width rows with product details.</p>
      </div>
          ...
          >
            <div className="hidden md:grid md:grid-cols-12 gap-4 items-center">
              ...
              <div className="col-span-4">
                <h4 className="font-bold text-primary-black dark:text-primary-white">{product.name}</h4>
              </div>

              {/* Type */}
              <div className="col-span-3">
                <span className="text-sm text-primary-black/60 dark:text-primary-white/60">{product.type}</span>
              </div>

              {/* Price */}
              <div className="col-span-2">
                <span className="font-bold text-primary-orange">{product.price}</span>
              </div>
            ...
            <div className="md:hidden space-y-3">
              <div className="flex items-start justify-between">
                <div>
                  <h4 className="font-bold text-primary-black dark:text-primary-white">{product.name}</h4>
                  <p className="text-xs text-primary-black/60 dark:text-primary-white/60 mt-1">{product.type}</p>
                </div>
                <span className="font-bold text-primary-orange">{product.price}</span>
              </div>
