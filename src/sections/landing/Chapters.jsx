        ...
        {[
          {
            num: "01",
            title: "Essentials",
            desc: "Practical products designed for everyday needs, with simple experiences and dependable functionality.",
          },
          {
            num: "02",
            title: "Professional",
            desc: "More capable solutions for growing teams that need flexibility, deeper features, and greater control.",
          },
          {
            num: "03",
            title: "Featured",
            desc: "A selection of standout products chosen for their value, usability, and overall experience.",
          },
        ].map((chapter, idx) => (
          <a
            key={chapter.num}
