...
export default function LandingPage({ onNavigate }) {
  ...
  return (
    <main className="min-h-screen bg-primary-white dark:bg-primary-dark-bg text-primary-black dark:text-primary-white font-sans selection:bg-primary-orange selection:text-primary-white transition-colors">
      ...
      <section
        ref={quotesRef}
        className={`py-20 px-8 md:px-16 md:max-w-5xl mx-auto border-y border-primary-black/10 dark:border-primary-white/10 ${quotesVisible ? "animate-fade-in-up" : "opacity-0"}`}
      >
      ...
      <section
        ref={methodologyRef}
        className="py-20 px-8 md:px-16 md:max-w-7xl mx-auto border-t border-primary-black/10 dark:border-primary-white/10"
      >
        <h2
